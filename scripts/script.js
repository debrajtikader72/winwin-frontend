...
let localBalance = parseFloat(localStorage.getItem('userBalance'));
if (isNaN(localBalance)) localBalance = data.balance;
...
if (navImg && data.profilePic) navImg.src = data.profilePic;
}
} catch (err) {}
}
